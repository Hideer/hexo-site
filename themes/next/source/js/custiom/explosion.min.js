...
function animateParticules(e, t) {
  ...
  anime.timeline().add({
    ...
    radius: .1,
    duration: anime.random(1200/3, 1800/2),
    easing: "easeOutExpo",
    update: renderParticule
  }).add({
    targets: a,
    radius: anime.random(80/3, 160/3),
    lineWidth: 0,
    alpha: {
      value: 0,
      easing: "linear",
      duration: anime.random(600/3, 800/3)
    },
    duration: anime.random(1200/3, 1800/3),
    easing: "easeOutExpo",
    update: renderParticule,
    offset: 0
  })
